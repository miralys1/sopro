...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{p{.25\textwidth} X}
		\rowcolor[HTML]{C0C0C0} 
		\textbf{Klassenname} & \textbf{Aufgabe} \\
		ListActivity &  \compress \begin{itemize}
		
\item MainActivity und Übersicht über sichtbare Kompositionen \end{itemize} \\
		\rowcolor[HTML]{E7E7E7} 
		SettingsActivity &  \compress \begin{itemize} \item Activity zum Festlegen von Einstellungen, zum Einloggen und Festlegen der Serveradresse \end{itemize}\\ 
		DetailActivity & \compress \begin{itemize}\item Detailansicht zur grafischen Darstellung einer Komposition \end{itemize}\\
		\rowcolor[HTML]{E7E7E7} 
		Settings & \compress \begin{itemize}		\item Dient zur Kapselung der getroffenen Einstellungen \end{itemize}\\
		CompositionView & \compress \begin{itemize}
