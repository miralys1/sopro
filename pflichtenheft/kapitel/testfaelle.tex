...
\begin{figure}[!h]
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{ p{.05\textwidth} | p{.2\textwidth} | X | X }
			...
			\stepcounter{test}\arabic{test} & App-1 & 
			Ein registrierter Nutzername und das dazu passendes Passwort werden eingegeben.& Der Login ist erfolgreich und es wird die erweiterte Listenansicht der Kompositionen angezeigt.
			\\ \hline
