...
\begin{figure}[!h]
	\begin{center}
		\begin{tabularx}{\textwidth}{ p{.05\textwidth} | p{.2\textwidth} | X | X }
			...
			1 & Web-1/2 & Nutzende ohne Administrator-Rechte versuchen, einen Dienst einzufügen. & Die Aktion wird verweigert und es wird eine passende Fehlermeldung angezeigt.\\ \hline
			2 & Web-1 & Nutzende mit Administrator-Rechten wählen aus, einen Dienst manuell einzufügen. & Es wird das Eingabeformular für Dienste angezeigt. \\ \hline
			...
			8 & Web-3 & Nutzende ohne Administrator-Rechte versuchen einen Dienst zu bearbeiten. & Es wird eine passende Fehlermeldung angezeigt.\\ \hline
