...
\begin{figure}[h]
	...
	\begin{tabularx}{\textwidth}{ X | X }
		...
		\textbf{Vorbedingungen} & Nutzer hat sich eingeloggt  \\ \hline
		\textbf{Nachbedingungen} & Neuer Dienst wurde in Datenbank gespeichert \\ \hline
		\textbf{Ablauf} &
		\begin{enumerate}
			\item  Administrator öffnet Dienst einfügen Seite.
			\item  Administrator gibt Dienstdetails in Eingabemaske ein.
			\item  Administrator bestätigt seine Eingabe.
		...
		\begin{enumerate}
			...
			\item  Administrator gibt Dienstdetails in Eingabemaske ein.
			\item  Administrator bestätigt seine Eingabe.
			\item  System akzeptiert Eingabe nicht, da unvollständige Eingabe.
			\item  System zeigt Fehler und markiert fehlende Felder.
			\item  bleibe in der Eingabemaske.
		\end{enumerate}  \\ \hline
		\textbf{Benutzte Anwendungsfälle} & WEB-2 \\ \hline
		\textbf{Spezielle Anforderungen} & - \\ \hline
		\textbf{Annahmen} & -
	\end{tabularx}
